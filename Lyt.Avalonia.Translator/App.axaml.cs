...
namespace Lyt.Avalonia.Translator;

public partial class App : ApplicationBase
{
    public const string Organization = "Lyt";
    public const string Application = "Translator";
    public const string RootNamespace = "Lyt.Avalonia.Translator";
    public const string AssemblyName = "Lyt.Avalonia.Translator";
